  <!-- UNTUK TAMPILAN KASIR PENJUALAN -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        Laporan Penjualan
		<small>Menampilkan laporan data penjualan</small>
      </h1>
      <ol class="breadcrumb">
            ...
            <div class="box-body table-responsive">
                ...
                foreach ($data as $key) {
                  ...
                  <tr>
                    ...
                    <td>
					  <center>
					  <a href="<?php echo base_url(); ?>index.php/kasirtoko/penjualan_detail?tgl=<?php echo $key['tanggal']; ?>">
                      <button type="button" data-toggle="modal" class="btn btn-primary fa fa-eye"> Lihat Detail</button>
					  </a>
					  </center>
					 </td>
                  </tr>
