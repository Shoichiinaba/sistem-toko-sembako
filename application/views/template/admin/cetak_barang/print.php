		...
		<table class='tabel'>
			<thead>
				<tr>
                  ...
                  <th style="font-size:14px;">Harga(Rp)</th>
				  <th style="font-size:14px;">Stok</th>
				  <th style="font-size:14px;">Penempatan</th>
				</tr>
			</thead>
			<tbody>
				<?php
                ...
                foreach ($data as $key) {
                  ...
                  <tr>
                    ...
                    <td style="text-align:justify;"><?php echo $key['nama_barang'];?></td>
					<td><center><?php echo $key['satuan'];?></center></td>
					<td><center><?php echo rupiah($key['harga_jual']);?></center></td>
					<td><center><?php echo $key['jumlah_stok'];?></center></td>
					<td><center><?php echo $key['nama_penempatan'];?></center></td>
                  </tr>
                  <?php } ?>
			</tbody>
		</table>
