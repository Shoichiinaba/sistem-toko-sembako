  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Jenis Barang
        <small>Menampilkan seluruh data jenis barang</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
          <div class="box-body">
            ...
            <button type="button" data-toggle="modal" data-target="#modal-primary" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Jenis</button>
          </div>
      <div class="box">
        <div id="refresh-box">
          <div class="do-refresh">
            ...
            <div class="box-body no-padding table-responsive">
              <table class="table table-striped tampil-jenis">
                <thead>
                  <tr>
              ...
              <tbody>
                ...
                foreach ($data as $key) {
                  ?>
                  <tr>
                    <td><?php echo $key['id_jenis_barang'];?></td>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Pembaharuan Jenis Barang</h4>
              </div>
              <div class="modal-body">
                <form id="form-input-jenis">
                  <div class="form-group">
                    <label>ID Jenis Barang</label>
                    <input type="text" name="id_jenis_barang" readonly class="form-control id">
                  </div>
                  <div class="form-group">
                    <label>Nama Jenis Barang</label>
                    <input type="text" name="nama_jenis" class="form-control nama" placeholder="Isi nama penempatan...">
                  </div>
                  <div class="form-group">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Entri Jenis Barang</h4>
              </div>
              <div class="modal-body">
                <div class="box-body">
                  <form id="form-input-jenis">
                  <div class="form-group">
                    ...
                    <input type="text" name="nama_jenis" class="form-control" placeholder="Jenis barang...">
                  </div>
                  <div class="form-group">
                    <label>Keterangan</label>
        ...
        <div class="modal modal-danger fade" id="modal-danger">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form id="form-hapus-jenis">
                <div class="form-group">
                    <label>ID Jenis Barang</label>
                    <input type="text" name="id_jenis_barang" class="form-control" placeholder="Masukan nama barang anda" value="" readonly>
                  </div>
                </form>
                  <div class="form-group">
                    <label>Jenis Barang : </label>
